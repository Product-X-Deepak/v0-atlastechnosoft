      ...
      <div className="container px-4 md:px-6 lg:px-8">
        <div className="mx-auto mb-12 text-center">
          ...
          <p className="mt-4 text-lg text-[#d0d8e0] max-w-2xl mx-auto">
            Our solutions help distribution and logistics businesses overcome complex challenges, streamline operations, and elevate their position in the competitive supply chain ecosystem.
          </p>
        </div>
