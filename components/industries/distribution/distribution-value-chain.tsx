      ...
      <div className="container px-4 md:px-6 lg:px-8">
        <div className="mx-auto mb-12 text-center">
          <div className="inline-flex items-center rounded-full border border-amber-600/30 bg-amber-100/80 px-4 py-2 text-sm font-medium text-amber-800">
            <span>Supply Chain Value</span>
          </div>
          <h2 className="mt-4 text-3xl font-bold tracking-tight text-[#f0f4f8] md:text-4xl">
            Connect Your <span className="text-[#E84A0E]">End-to-End Supply Chain</span>
          </h2>
          <p className="mt-4 text-lg text-[#d0d8e0] max-w-2xl mx-auto">
            Creating value in distribution is all about connecting inventory, transportation, warehousing, and fulfillment. Optimize every step of your logistics operations.
          </p>
        </div>
