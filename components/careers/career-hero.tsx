...
function CareerHero() {
  ...
  return (
    <section ref={ref} className="relative overflow-hidden bg-[#FFF5D6] py-8">
      <div className="container relative z-10 px-4 md:px-6 lg:px-8">
        ...
        <div className="mx-auto mt-4 max-w-4xl text-center">
          <h1 className="mb-3 text-2xl font-bold tracking-tight text-slate-800 sm:text-3xl md:text-4xl">
            Shape the <span className="text-[#E84A0E]">Future</span> with <br />
            <span className="text-[#A73370]">Atlas Technosoft</span>
          </h1>
          <p className="mx-auto mb-4 max-w-2xl text-base text-slate-700">
            Join a team of visionaries and innovators dedicated to transforming businesses through cutting-edge technology solutions. Discover a career that empowers growth, innovation, and excellence.
          </p>
        </div>
      ...
      <div className="absolute bottom-0 right-0 -z-10 h-[250px] w-[250px] md:h-[400px] md:w-[400px]">
        <Image 
          src="/images/careers/career-hero-pattern.svg" 
...
const benefits = [
  {
    icon: <Rocket className="h-4 w-4 text-[#E84A0E]" />,
  ...
  },
  {
    ...
    description: "Grow your skills with training and development",
  },
  {
    icon: <Users className="h-4 w-4 text-[#A73370]" />,
    title: "Collaborative Culture",
    description: "Work with diverse and talented teams",
  },
  {
    icon: <Award className="h-4 w-4 text-[#E84A0E]" />,
    title: "Career Advancement",
    description: "Clear paths for professional growth",
  },
] 
// Wrapper component to ensure proper Suspense boundaries for useSearchParams
function CareerHeroWrapper(props: Record<string, never>) {
  return (
...
export { CareerHeroWrapper as CareerHero };