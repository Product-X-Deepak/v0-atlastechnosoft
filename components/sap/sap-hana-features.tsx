    ...
    >
      ...
      <div className="container px-4 sm:px-6 lg:px-8 py-10">
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {analyticsFeatures.map((feature, index) => (
                  ...
                  >
                    <meta itemProp="position" content={(index + 1).toString()} />
                    <Card className="h-full overflow-hidden border-slate-200 transition-all duration-300 hover:border-[#A73370]/50 hover:shadow-lg dark:border-slate-800 dark:hover:border-[#A73370]/50">
                      <CardHeader className="pb-2 pt-4 px-4">
                        <div className="mb-2 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#A73370]/10 text-[#A73370]">
                          {feature.icon}
                        </div>
                        <CardTitle 
                          className="flex items-center justify-between text-base"
            ...
            >
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {architectureFeatures.map((feature, index) => (
                  ...
                  >
                    <meta itemProp="position" content={(index + 1).toString()} />
                    <Card className="h-full overflow-hidden border-slate-200 transition-all duration-300 hover:border-[#1E1E38]/50 hover:shadow-lg dark:border-slate-800 dark:hover:border-[#1E1E38]/50">
                      <CardHeader className="pb-2 pt-4 px-4">
                        <div className="mb-2 inline-flex h-8 w-8 items-center justify-center rounded-lg bg-[#1E1E38]/10 text-[#1E1E38]">
                          {feature.icon}
                        </div>
                        <CardTitle 
                          className="flex items-center justify-between text-base"
        ...
        <motion.div
          ...
          className="mx-auto mt-12 max-w-6xl rounded-xl bg-gradient-to-r from-slate-50 to-[#FFF5D6] p-6 dark:from-slate-900 dark:to-[#1E1E38]"
        >
          <div className="flex flex-col items-center gap-6 lg:flex-row">
            <div className="flex-1">
              <h3 className="text-xl font-bold">SAP HANA Cloud</h3>
              ...
              <ul className="mt-3 space-y-1.5">
                <li className="flex items-center">
                  <div className="mr-2 h-1 w-1 rounded-full bg-[#E84A0E]"></div>
                  <span className="text-xs">Serverless scaling from gigabytes to petabytes</span>
                </li>
                <li className="flex items-center">
                  <div className="mr-2 h-1 w-1 rounded-full bg-[#E84A0E]"></div>
                  <span className="text-xs">Unified database and data management</span>
                </li>
                <li className="flex items-center">
                  <div className="mr-2 h-1 w-1 rounded-full bg-[#E84A0E]"></div>
                  <span className="text-xs">Built-in data integration and quality tools</span>
                </li>
                <li className="flex items-center">
                  <div className="mr-2 h-1 w-1 rounded-full bg-[#E84A0E]"></div>
                  <span className="text-xs">99.9% uptime SLA and automated operations</span>
                </li>
              </ul>
            </div>
            <div className="relative h-[240px] w-full max-w-[420px] overflow-hidden rounded-lg shadow-lg lg:flex-1">
